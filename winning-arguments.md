...
The conclusion of the *t*-test is justified assuming that the *t*-test was carried out by correct procedures, and to the extent that the assumptions of the *t*-test are met. The assumptions of the *t*-test are essentially never met perfectly by real world data. For example, it is usually impossible (as in the case of populations of people) to gather a perfectly representative sample. Addressing the question of how closely the assumptions of a statistical test are met, and how problematic the inevitable deviations from the assumptions are likely to be, is a complex matter of opinion and guesswork. This is one of the main reasons that application of statistical methods to real problems is so problematic and error-prone.
