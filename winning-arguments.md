...
What conclusion are we led to about whether games are always cooperative? In this case we're led to **no single conclusion**. What we've said indicates that if self-cooperation is a form of cooperation, then games are always cooperative (as is every activity), and on the other hand, if self-cooperation is not a form of cooperation, then games are not always cooperative. In addition, what we've said indicates that multi-player games are always cooperative.
