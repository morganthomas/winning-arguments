...
* In serious contexts where you need to solve a problem, rationality is usually applicable. In these cases, the laws of rationality are binding in the sense that following them usually maximizes your likelihood of success. There is an approximation of a Nash equilibrium in the global game of civilization around making decisions as rationally as one is able.
