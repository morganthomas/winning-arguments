...
This metaphysics is based on one premise: the Law of One. This is the only premise we need assume, because it entails that every statement is true. From this point to the end of this section, our norms of discourse have changed completely compared to the rest of the book. Having made an assumption which entails every conclusion, there is no longer any sense in trying to prove anything. The goal now is simply to *describe* how things are given the Law of One, in a way that is intended to be as understandable as possible.
