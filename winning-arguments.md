...
The disanalogy also reminds us of a question we asked a ways back and still haven't answered: is human life a game? To illustrate the silliness of this particular question, let's ask a more basic question: is life a gamelike activity? To ask this is to ask whether life is like games, especially typical games. The answer to this is that life is like them in some ways (e.g., you have to follow rules), and unlike them in other ways (e.g., most games don't inevitably end in death, whereas all human lives do).
