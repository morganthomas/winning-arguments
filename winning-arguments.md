...
What is knowledge? One long-standing, once-popular theory goes back to Socrates in the *Theaetetus*. This theory states that knowledge is justified true belief. In other words, for all statements *A*, I know *A* if and only if *A* is true, I believe *A*, and I have (appropriate) justification for believing *A*.
