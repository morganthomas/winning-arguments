...
To sum up, the classic argument we have analyzed is valid according to classical logic. Given that Socrates is a man and all men are mortal, it follows that Socrates is mortal. It is incoherent to assert that Socrates is a man and all men are mortal while denying that Socrates is mortal.
