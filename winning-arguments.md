...
Opponents of "no statement is both true and false" include **dialetheists**. These are people like Graham Priest, Jc Beall, and the author who believe that there are true contradictions, i.e. statements that are both true and false. It is not a purpose of this text to argue for dialetheism; though the author is a dialetheist, for the purposes of this text the reader can regard dialetheists as a strange group of people with a bizarre view that ought to be rejected.
