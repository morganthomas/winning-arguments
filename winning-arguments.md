...
In order to investigate further, we shall abandon contrived examples, look at some semi-randomly chosen statements from books that are in my house, and try to translate them into first-order logic.
