...
As you can see, there is some reason to be less than confident in asserting that every statement is either true or false. Let's look at some conditions under which the law of excluded middle is uncontroversially true.
