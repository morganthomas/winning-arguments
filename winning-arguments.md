...
One example of a law of reasoning is that properly formulated *reductio ad absurdum* arguments are winning. This law is basically correct. However, this formulation of it is still imprecise, and at this point we lack the methodology to justify or even to state precisely the *reductio ad absurdum* principle. Furthermore, there is plenty of controversy around the *reductio ad absurdum* principle among logicians, which we should review. 
