...
Morgan Thomas is the author. I am indebted to everybody who has done philosophy with me, whose philosophy I have read, or whose example has inspired me. They are too many to name, but they include (in no particular order) Lao Tzu; [JR](http://www.crazywisdomjournal.com/featuredstories/2014/8/22/the-crazy-wisdom-interview-with-jim-robert-of-pioneer-high-school); my parents Amy and Spencer Thomas; my sibling Esty; my friends Arian, Alexis, Thoi, Chloe, Becca, Graeme, Daniel S., Eric A., Isaac S.; Eliezer Yudkowsky; [Carla L. Rueckert, Don Elkins, and James McCarty](http://www.llresearch.org/aboutus.aspx); Ra; Aleister Crowley; various great Eastern mystics; the members of the Zen Buddhist Temples in Ann Arbor, MI and Tempe, AZ around 2010--2013; Crispin Wright; Graham Priest; Jc Beall; Michael Dummett; Nathan Kellen; Andrew Parisi; Hanna Gunn; Madiha Hamdi; Junyeol Kim; Teresa Allen; David Baldwin; Emma Björngard; Rasa Davidaviciute; Joel Hamkins; Alycia LaGuardia-LoBianco; Joseph Lurie; Colin McCollough-Benner; Tom Meagher; Dana Francisco Miranda; Jordan Ochs; David Pruitt; Nate Sheff; Andrew Tedder; Daniel Silvermint; Donald Baxter; Suzy Killmister; Mitch Green; Hallie Liberto; Bill Lycan; Michael Lynch; Dave Ripley; Marcus Rossberg; Susan Schneider; Stewart Shapiro; Daniel Silvermint; Keith Simmons; Samuel Wheeler; Ruth Millikan; Immanuel Kant; Jean-Paul Sartre; Martin Heidegger; Ludwig Wittgenstein; Gottlob Frege; Bertrand Russell; Kurt Gödel; Damir Dzhafarov; Reed Solomon; Alan Turing; Joseph P. Foy; Michel Foucault; Alvin Plantinga; Grace Paterson; Gregg J.; Kyle M.; Mark S.; Bethany B.; Luis Anderson; Socrates; Hal Kierstead; and many others, too many to name.
...
In solitary games the obvious comment would be that there is no cooperation because cooperation requires multiple people. This is true in an obvious sense. However, it's also false in a less obvious sense, in that playing a game requires internal coordination on the part of a person. In order to play a game, a person has to coordinate many different parts of their mind and body, orchestrating their activities in such a way as to accomplish a single task. In the same sense, every activity whatsoever done by a person involves self-cooperation. One could fairly object that self-cooperation is an undue extension of the term "cooperation," and I will not press the point.
...
Second example. Suppose you have a mathematical statement, and you don't know whether it's true or false, but you do know that you could write a computer program which could run a finite number of computations that, at the end, would tell you with certainty either that the statement is true, or that the statement is false. It doesn't matter if the program would necessarily take thousands of years to finish running. The supposition isn't that you have actually written the program; the supposition is merely that you know that such a program could be written. If you know this supposition is true, then you know the mathematical statement under question is either true or false. This is because you know that it's possible in principle to write the program, and it's possible in principle run it to completion, and if you did that you would obtain either proof that the statement is true, or proof that the statement is false. This shows that 
