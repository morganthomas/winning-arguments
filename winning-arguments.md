...
When speaking English, people usually follow rules of grammar. Sometimes people violate the rules of grammar they normally follow. Different English speakers sometimes follow different rules of grammar. For example, African American vernacular English (AAVE) has different rules of grammar than standard American English. "He be tall" is gramatically valid AAVE, but not gramatically valid standard American English. People sometimes follow different linguistic rules in different contexts, as for example when a black person speaks African American vernacular English (AAVE) with their family and standard American English at work. Following different linguistic rules in different contexts is called "code-switching."
