...
This discussion of the axiom of regularity, like our discussion of the axiom of extensionality, serves to illustrate that ZFC is not the only possible way of axiomatizing sets; there are ways of imagining the universe of sets under which not all the axioms of ZFC are true. For example, [New Foundations](https://en.wikipedia.org/wiki/New_Foundations) (so called) is a set theory in which the axiom of regularity is false, and which contradicts ZFC on many other points, but which (at least in weakened forms such as [NFU](https://en.wikipedia.org/wiki/New_Foundations#Models_of_NFU)) is logically consistent (if ZFC is logically consistent).

In this list of the axioms of ZFC, after the axiom of extensionality and the axiom of regularity comes an infinite series of axioms, stating for every statement *P* of first-order logic (in the vocabulary of ZFC) that for every set *A*, there exists the set of elements of *A* of which *P* is true. Each statement of first-order logic (in the vocabulary of ZFC) generates one instance of the axiom schema of specification stating the same.
...
It is an idea validated by experience that the ad hoc method of rejecting contradictions is a pragmatically adequate way of dealing with the paradoxes that are inherent in the interaction between classical logic and self-referential natural language. As a long-time user of classical logic, it has never failed me, even when I have looked for the places where it is most likely to fail (see TODO).

The ad hoc method of rejecting contradictions is not my only tool for thinking about and around paradoxes (see the section titled The Law of One). It doesn't meet all the needs in my personal and social lives which involve paradox or contradiction. I don't always apply the method, but when I have applied the method as a means of guarding against contradictions, I have not encountered a case where my reasoning led me to contradictions that crept into my work sight unseen without an evident paradox being exploited anywhere in the reasoning, except when this has happened as a result of my own error in applying the rules of classical logic or as a result of false assumptions.

In general, when you reject the absurd implications of paradoxes via the ad hoc method of rejecting contradictions, you don't see the absurdities that follow from the paradoxes unpredictably popping up in the conclusions of your reasoning about other things. Rather, you dispose of the matter, as far as I've seen.
...
I do agree that the risk the counter-argument points to exists. I simply consider the risk adequately small for practical purposes.
...
All competing approaches that I'm aware of for solving logical paradoxes are based on weakening the systems of rules that give rise to the paradoxes. For example, to solve the liar paradox, one can propose weakening the rules of logic, or weakening the self-referential capabilities of language. It's not apparent to me how the latter approach can make sense for natural language, since natural language, to express our thoughts, inherently seems to require the ability to talk about itself in arbitrarily flexible ways, and this ability seems to unavoidably give rise to paradoxes like the liar. The competing solutions to the liar paradox that I'm aware of all ride on weakening the rules of logic.
...
The biggest source of inspiration for the explanations of this section is [the general theory of reflexivity, as explained by George Soros in his lecture at Central European University, Oct. 26 2009](https://www.youtube.com/watch?v=oCaCrWzFPYY). I highly recommend this talk; in my opinion, although George Soros is or at least appears to be a malevolent actor in some of his doings in the global game of society, his general theory of reflexivity is fundamentally true and insightful.
...
Let me close with some consideration of how my view relates to competing views. Basically, my view is opposed to the view that rationality is not a style of cognitive bias, and that the goal of approaching being unbiased is an idea that has sense. There are basically two ways of looking at the disagreement between my view and this view. On the one hand, one can hold that the disagreement is terminological: i.e., that good versions of the opposing view mean something other than what I mean by the term "bias," but what they mean is also a sensible notion. On the other hand, one can hold that the disagreement is substantive: i.e., that my view and the opposing view are basically talking about the same thing when we talk about "bias," and there is disagreement about whether it's true that rationality is a form of cognitive bias. I think there is also some vague middle ground between these two ways of looking at the disagreement.

I have offered a general theory of cognitive biases according to which cognitive biases steer in particular our cognitive processes of information selection and interpretation selection, thereby influencing the outputs of our cognition. To me it seems evident that on this way of understanding cognitive biases, rationality is a style of cognitive bias. Maybe there are reasons to disagree with this, but I don't have any to offer. Please let me know if you think of some.

One could also disagree with my view by presenting a different general theory of what cognitive biases are, which explains what it means to approximate being unbiased. Here's one trivial way to do that. Say that a cognitive bias is a psychological tendency which causes people to tend towards false thoughts/beliefs. To approach being unbiased is to approach lacking any cognitive biases. On this understanding of cognitive biases, it is basically true by definition that rationality is not a style of cognitive bias, because processes which tend to lead us to falsehoods are not rightly called rational, as a generalization. On this understanding, to approach being unbiased is to reduce the tendency of one's cognitive processes to lead to false conclusions.

One who disagrees with me by going in this direction is setting up a terminological disagreement. They mean something different by "cognitive bias" than what I mean. I can't compel them to use the term "cognitive bias" the way I do, and they can't compel me to use the term "cognitive bias" the way they do.

There are, however, substantial differences between the two theories I've presented, in terms of what work they do. The theory of biases I endorse offers a high-level explanation of how cognitive biases relate to the internal workings of cognition. It says that cognitive biases mainly relate to the processes of selecting and interpreting information. In contrast, the opposing theory I've presented offers no theory of how cognitive biases relate to the internal workings of cognition. It merely relates cognitive biases by definition to an (unexplained) notion of truth. I would contend that my theory is likely to be more productive of psychological insights. You can form your own opinion.
...
There are various objections to the Law of One along the lines of: it's unthinkable, it's intuitively obvious that it's false, etc. These objections lack adequate justification, because I can provide counterexample. After working for many years, I have an intuitive understanding of the Law of One which renders it not only thinkable to me but even common sense to me. It is the heart of my intellectual foundations, the thing upon which logic, mathematics, and all the rest are founded in my mind. To me it is intuitive, though it has never ceased to be mind-melting. I expect that others can obtain to a feeling of comprehension similar to mine with heightened ease through the assistance of this text. However, I would not be surprised if it took years of patient and dedicated contemplation and meditation anyway. Others' experiences learning the Law of One with my help are at the point of this writing still wholly uncharted territory for me.
...
I think there are additional benefits to accepting the Law of One. I have found my meager intellectual grasp of the Law of One to be an unbelievably productive cognitive tool. My attempts to understand the Law of One and to reconcile it with logic were the germ of this book. I would say that wrestling with the unthinkable paradox at the heart of the Law of One has done more than anything else to deepen my thinking.

My understanding of the Law of One also helps me to heal my emotional pains by loving and accepting everything as the one infinite creator. My intellectual view that everything is one with the infinite creator helps me to do this.
...
All the objects mentioned so far are concrete objects. An object *x* is **concrete** if and only if *x* has a part *y* such that *y* is part of the physical world. In particular, since (by definitional stipulation) every object *x* is a part of itself, if *x* is part of the physical world then *x* is concrete. From the perspective of Cartesian dualism, a human is an example of a concrete object which is not part of the physical world. According to Cartesian dualism, the human mind is a non-physical object separate and distinct from the physical body. Therefore Cartesian dualism says humans are concrete objects which are not entirely physical: humans have a physical part, the body, but humans also have a non-physical part, the mind, so as a whole a human is not a part of the physical world.

An **abstract** object is any object which is not concrete. In other words, an object *x* is abstract if and only if *x* has no part *y* such that *y* is part of the physical world. Tautologically, every object is either concrete or abstract. Some types of abstract objects are: sets, predicates, numbers, and any kind of mathematical object.
...
A print edition of a book, for example, is a concrete object which has both physical and abstract parts. A print edition of a book can be thought of as the mereological sum of the copies that form parts of the print edition. One can also divide the print edition into parts in other ways, such as by dividing it into the chapters, sections, or pages of the edition, considering each chapter to be the mereological sum of its physical instances, and so forth.
...
* On the other hand, if one equates a page of a print edition with the mereological sum of the copies of the page, then from that point of view the page is a concrete object.
...
* Another point of view on the page is to regard the page as the mereological sum of all objects with which the page can reasonably be equated. This is a vague and ambiguous but (formally, theoretically) all-encompassing point of view on the page.
...
Each of the perspectives on a page in bullet points above is one partial way of thinking about a page. Every experience of a page possible to humans is a partial way of experiencing the page. It is coherent with our experience, and according to the perspective I've laid out, coherent with logic, to regard a theoretical complete experience of a page as an experience of the page as everything, viewed from all perspectives.
...
The more abstract sense of faith I want to articulate does not particularly have to do with beliefs, practices, rules, the intellect, or action/behavior. Faith in this more abstract sense is a type of internal state of a person, but not specifically an intellectual state.

I define faith, in this more abstract sense, as a type of experience. In this statement I am conflating two distinct senses of "experience." *Experiences* (first sense) are conscious events, roughly speaking; e.g.: my experience of typing this, my most recent experience of eating ice cream. *Experience* (second sense) is a quality which sentient beings such as humans acquire over the course of many experiences, which enables us to respond to our experiences in more advantageous/effective ways. For example, I have had many *experiences* of programming computers, and the *experience* I have garnered from doing so makes software companies want to hire me.

Faith is a type of experience, I defined. This sense of faith, then, conflates two sub-senses: *faith experiences* and *faith experience*. *Faith experiences* are spiritual experiences, or mystical experiences; I do not draw distinctions in meaning between those three phrases. *Faith experience* is a type of experience sentient beings can acquire over time through faith experiences.
...
Faith experience is a property of a sentient being resulting from faith experiences over time. In the current theory, the development of faith experience is the primary direct and positive effect of faith experiences on people. Faith experience is a result of the transformations catalyzed by exposure to the truth through faith experiences. Such exposure can be mind-blowing in the extreme when it is sudden and powerful, but it can also be a subtler and more gradual process. I believe there is a tremendous variety in the faith experiences possible to people, and similar variety in the faith experience which people can develop. Most of this variety lies outside of any language I can articulate. My statement that this variety exists is based on recollection of my own experiences and presumption/inference of endless possible experiences I haven't had.
...
What changes in your life, if any, would you attribute to faith experience/experiences? I give a lot of credit for my own intellectual fertility to my faith experience/experiences. I thank and credit God for supplying me with inspiration. Moreover, there is basically no aspect of my life which I consider unaffected by faith. Faith brings comprehensive transformation of my mind, body, and spirit, or that's how I see it. I thank God for being the ground of being which feeds the roots of faith. I thank God for being the self, the one logic cannot comprehend, the one who is all and everything, the universal intelligence, from whom flows all life, all energy, all consciousness, and all matter, next to whom all is illusion.
