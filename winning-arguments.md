...
Other possible counterexamples I'm aware of can be disposed of by thinking along similar lines. It looks to me like any appearance of a gamelike activity lacking rules is due to failure to look sufficiently broadly for rules governing the activity. In interpreting this statement, it should be understood that rules need not be inviolable to be rules.
