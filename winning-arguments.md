...
I started out this section by presenting the one-directional notion of rules of logical inference, according to which rules of logical inference let us pass from true, warranted assertible statements to other true, warranted assertible statements. Our inquiry has shown us that this is an incomplete picture, in that every person who accepts the rules of logic and reads a logical argument has two options: to accept the conclusion or to reject one or more of the premises. In real debates logic is not necessarily used simply to pass from truth to truth; instead, it constrains humans to bounce about as they will in the space of logically coherent positions (and in practice of course humans often find themselves in logically incoherent positions; it may take them a long time to notice that; and they may never notice).
