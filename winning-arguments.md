...
If life is and is not a game, then you might expect that winning at life both is and is not possible, in different senses. We have already seen this to be the case. Winning at life is not possible in the sense that there will rarely be a widely accepted consensus that a certain person won at life. Winning at life is possible in the sense that there are inexhaustibly many frames of evaluation from which one can apply the judgment that a certain course of action did or is likely to lead to winning at life. Of course, the most practical case is the case where one adopts a certain frame of evaluation as the frame of evaluation one routinely applies to one's own life, and then one proceeds to attempt to win at life according to the standards of that frame of evaluation. Almost everybody does this to some extent. It is probably more accurate to say that people apply many different frames of evaluation to many different parts of their lives as their lives go on, and that these frames of evaluation generally evolve continuously but conflicts often exist, where different frames of evaluation applied simultaneously or at different times yield conflicting conclusions. This can lead to regret about past decisions, a sense of turmoil and conflict in one's present, etc.
