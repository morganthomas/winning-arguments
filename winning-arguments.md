...
This simple way of approaching uncertaintly is frequently the best or only available way. One reason for this is that time pressure and scarcity of intellectual resources usually prevents the employment of more rigorous decision making methods, such as can be developed using statistics, probability, and [decision theory](https://en.wikipedia.org/wiki/Decision_theory). 
